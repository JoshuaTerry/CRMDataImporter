...
{
    public class PhoneCallMapper : MapperBase<PhoneCall>
    {
        public PhoneCallMapper(bool update)
            : base(SourceDatabaseEnum.CRM3, update) 
        {
            this.Query = @"
                            ...
                            where Party.ActivityId = PhoneCall.ActivityId 
                            FOR XML RAW('Party'), TYPE, Root('Parties')) as 'Parties', 
                            cast (PhoneCall.DirectionCode as bit) as 'DirectionCode',
                            PhoneCall.CreatedOn as 'OverriddenCreatedOn',
                            PhoneCall.[Subject],
                            PhoneCall.[Description],
                            PhoneCall.RegardingObjectId,
                            PhoneCall.RegardingObjectTypeCode as 'RegardingObjectIdMapperTypeCode', 
                            ...
                            inner join SystemUser su
	                            on su.SystemUserId = PhoneCall.OwnerId  
                            ";
        }
        ...
        protected override bool MapField(string name, IDataReader reader, NewEntityModel model)
        {
            if (name == "Parties")
            {
                ...
                var typesWeCareAbout = new int[] { 1, 2}; 
        ...
        public override bool IsImportable(PhoneCall entity)
        {
            return !DestinationKeyExists(entity.ActivityId.Value,"PhoneCall") && (entity.RegardingObjectId == null ||
